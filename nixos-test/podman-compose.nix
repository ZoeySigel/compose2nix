...

{
  ...
  systemd.services."podman-myproject-entrypoint" = {
    ...
    unitConfig.Description = "Container myproject-entrypoint generated by compose2nix.";
    after = [
  ...
  systemd.services."podman-myproject-no-restart" = {
    ...
    unitConfig.Description = "Container myproject-no-restart generated by compose2nix.";
    after = [
      "podman-network-myproject_default.service"
    ];
    requires = [
  ...
  systemd.services."podman-service-b" = {
    ...
    startLimitBurst = 3;
    unitConfig = {
      Description = "Container service-b generated by compose2nix.";
  ...
  systemd.services."podman-network-myproject_another" = {
    unitConfig.Description = "Network myproject_another generated by compose2nix.";
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
  ...
  systemd.services."podman-network-myproject_something" = {
    unitConfig.Description = "Network myproject_something generated by compose2nix.";
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
  ...
  systemd.services."podman-volume-myproject_books" = {
    unitConfig.Description = "Volume myproject_books generated by compose2nix.";
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
  ...
  systemd.services."podman-volume-storage" = {
    unitConfig.Description = "Volume storage generated by compose2nix.";
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
